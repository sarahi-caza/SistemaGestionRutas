            ...
            <center>
                ...
                @csrf
                    <table>
                        ...
                        <table class="table table-info table table-sm ">
                            ...
                            @foreach($horario->turno_semanal as $turno)
                                <tr>
                                    ...
                                    <td>
                                        <select name="ma-{{$turno['empleado']}}" class="form-select form-select-sm mb-1 form-control" disabled>
                                    ...
                                    <td>
                                        <select name="mi-{{$turno['empleado']}}" class="form-select form-select-sm mb-1 form-control" disabled>
                                    ...
                                    <td>
                                        <select name="ju-{{$turno['empleado']}}" class="form-select form-select-sm mb-1 form-control" disabled>
                                    ...
                                    <td>
                                        <select name="vi-{{$turno['empleado']}}" class="form-select form-select-sm mb-1 form-control" disabled>
                                    ...
                                    <td>
                                        <select name="sa-{{$turno['empleado']}}" class="form-select form-select-sm mb-1 form-control" disabled>
                                    ...
                                    <td>
                                        <select name="do-{{$turno['empleado']}}" class="form-select form-select-sm mb-1 form-control" disabled>
                        ...
                        <br>
                        <a class="btn btn-info" href="{{ route('horarios.historial') }}" style="margin-left:130px" >Regresar </a>
                    </form>    
                </div>
            </center>
        </div>
